...
<div class="wrapper">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('categories.index')}}"><i class="fa fa-database"></i>مدیریت دسته بندی </a></li>
                    </ul>
                </li>
                </li>
                <li class="treeview">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('products.index')}}"><i class="fa fa-database"></i>لیست محصولات</a></li>
                    </ul>
                </li>
            </ul>
        </section>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2019 <a href="https://fingerfooda.ir">fingerfooda</a>.</strong> All rights
        reserved.
    </footer>
